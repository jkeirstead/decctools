...
#' Most of the underlying data comes from the Department of Energy and
#' Climate Change website, \url{http://www.decc.gov.uk}.  A working
#' internet connection is needed for almost all of the functions.
#'
...
#'
#' A data frame providing extra information about local administrative
#' districts (LADs) in the United Kingdom.  This includes the
#' following fields:
#' 
#' \itemize{
#' 
...
#' authorities) and local administrative units (LAUs, the pan-European
#' equivalent for EuroStat).
#'
...
#' interpolation was performed (with p = 0.2) to give a smooth surface
#' of degree days across the UK and this was sampled using the LAD
#' polygons to estimate the heating and cooling degree days in each
#' location.
#'
